...
def Matching_FS():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path_FS + "/ReferenceData/" + "2021104_14:22:5.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
...
def Matching_4000Hz():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path4000Hz + "/ReferenceData/" + "2021104_14:22:56_4000Hz.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
...
def Matching_8000Hz():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path8000Hz + "/ReferenceData/" + "2021104_14:22:56_8000Hz.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
...
def Matching_12000Hz():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path12000Hz + "/ReferenceData/" + "2021104_14:22:56_12000Hz.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
...
def Matching_16000Hz():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path16000Hz + "/ReferenceData/" + "2021104_14:22:56_16000Hz.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
...
def Matching_20000Hz():
    ...
    #画像の読み込み
    #デフォルト画像の読み込み
    img_DFT = cv2.imread(path20000Hz + "/ReferenceData/" + "2021104_14:22:56_20000Hz.png")  #""の中にファイル名を入力
    #テンプレート画像の読み込み
