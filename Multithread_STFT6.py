...
Loop_count_Value1 = 100
Loop_count_Value2 = 2000
#しきい値を指定
threshold_value_MAX = 0.1
threshold_value_MIN = 0.0001
#FFT検出強度のフィルタリング
...
def Graph_A():
    ...
    if rms_A >= threshold_value_MAX:
        plt.savefig("/home/pi/Documents/admp441_data/"+filename_A+"MAX_value"".png")
        file =  filename_A + ".wav"
...
#定期実行のスケジュールを設定するコマンド
schedule.every(30).minutes.do(job_A)
#schedule.every().day.at("0:00").do(job_A)
